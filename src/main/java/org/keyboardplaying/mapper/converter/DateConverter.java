...
public class DateConverter extends BaseTemporalConverter<Date> {
     ...
     */
    public Date convertFromString(String value, Date def) throws ConversionException {
        return value == null ? def : convertStringToDate(value);
    }
     ...
     */
    public String convertToString(Date value, Date def) {
        String result = null;
        if (value != null) {
            result = convertDateToString(value);
        } else if (def != null) {
            result = convertDateToString(def);
        }
        return result;
    }
}
