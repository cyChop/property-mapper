...
/**
 * Implementations of this interface are to be used to switch from object to
 * {@code String}.
 * <p/>
 * It should be implemented in such a way that, for any object,
 * {@code o.equals(convertFromString(convertToString(o)))} is {@code true}.
 * <p/>
 * <strong>Notice:</strong> This interface does not require for implementations
 * to be null-safe. It is up to the developer to ensure non-nullity when calling
 * a {@link Converter}.
 * <p/>
